...
const ReviewForm: React.FC = () => {
  ...
  return (
    < >
      <div className="shadow-md border border-slate-100 border-4 rounded-lg">
        <form onSubmit={handleSubmit} className="relative max-w-md mx-auto p-4 bg-slate-200 rounded-lg shadow-md">
          <button
            type="button"
            onClick={handleClose}
          ...
          <h2 className="text-l font-bold mb-4 text-center text-black">Leave a review</h2>
